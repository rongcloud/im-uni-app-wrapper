...
import {
    OnAllChatRoomEntriesLoadedResult,
    ...
    OnUltraGroupMessageExpansionRemovedResult,
...
let instance: RCIMIWEngine | undefined;

export default class RCIMIWEngine {
    private _invokeMethod<ResType>(name: string, params?: object): any {
        console.log(`invokeMethod methodName: ${name}, params:${params}`);
        return new Promise((resolve, _) => {
            RCUniIM.invokeMethod({ name, params }, (res: ResType) => {
                resolve(res);
            });
        });
    }
     ...
     * @returns 创建的 IM 对象
     */
    static async create(appKey: string, options: RCIMIWEngineOptions = {}): Promise<RCIMIWEngine | undefined> {
        if (instance) {
            return new Promise((resolve) => resolve(instance));
        }
        instance = new RCIMIWEngine();
        let code = await instance._invokeMethod('create', { appKey, options });
        if (code === 0) {
            return instance;
        }
    ...
    destroy(): Promise<number> {
        instance = undefined;
        return this._invokeMethod<void>('destroy');
    }
    ...
    getMessageById(messageId: number): Promise<{ code: number; message: RCIMIWMessage }> {
        return this._invokeMethod<{ code: number; message: RCIMIWMessage }>('getMessageById', { messageId });
    }
    ...
    getMessageByUId(messageUId: string): Promise<{ code: number; message: RCIMIWMessage }> {
        return this._invokeMethod<{ code: number; message: RCIMIWMessage }>('getMessageByUId', { messageUId });
    }
    ...
    connect(token: string, timeout: number): Promise<number> {
        return this._invokeMethod<number>('connect', { token, timeout });
    }
    ...
    disconnect(receivePush: boolean): Promise<number> {
        return this._invokeMethod<number>('disconnect', { receivePush });
    }
    ...
    createTextMessage(
        ...
        channelId: string,
        text: string
    ): Promise<RCIMIWTextMessage> {
        return this._invokeMethod<RCIMIWTextMessage>('createTextMessage', { type, targetId, channelId, text });
    }
    ...
    createImageMessage(
        ...
        channelId: string,
        path: string
    ): Promise<RCIMIWImageMessage> {
        return this._invokeMethod<RCIMIWImageMessage>('createImageMessage', { type, targetId, channelId, path });
    }
    ...
    createFileMessage(
        ...
        channelId: string,
        path: string
    ): Promise<RCIMIWFileMessage> {
        return this._invokeMethod<RCIMIWFileMessage>('createFileMessage', { type, targetId, channelId, path });
    }
    ...
    createSightMessage(
        ...
        path: string,
        duration: number
    ): Promise<RCIMIWSightMessage> {
        return this._invokeMethod<RCIMIWSightMessage>('createSightMessage', {
            type,
            targetId,
            channelId,
            path,
    ...
    createVoiceMessage(
        ...
        path: string,
        duration: number
    ): Promise<RCIMIWVoiceMessage> {
        return this._invokeMethod<RCIMIWVoiceMessage>('createVoiceMessage', {
            type,
            targetId,
            channelId,
            path,
    ...
    createReferenceMessage(
        ...
        text: string
    ): Promise<RCIMIWReferenceMessage> {
        return this._invokeMethod<RCIMIWReferenceMessage>('createReferenceMessage', {
            type,
            targetId,
            channelId,
            referenceMessage,
    ...
    createGIFMessage(
        ...
        channelId: string,
        path: string
    ): Promise<RCIMIWGIFMessage> {
        return this._invokeMethod<RCIMIWGIFMessage>('createGIFMessage', { type, targetId, channelId, path });
    }
    ...
    createCustomMessage(
        ...
        return this._invokeMethod<RCIMIWCustomMessage>('createCustomMessage', {
            type,
            targetId,
            channelId,
            policy,
    ...
    ): Promise<RCIMIWLocationMessage> {
        return this._invokeMethod<RCIMIWLocationMessage>('createLocationMessage', {
            type,
            targetId,
            channelId,
            longitude,
    ...
    sendMessage(message: RCIMIWMessage): Promise<number> {
        return this._invokeMethod<number>('sendMessage', { message });
    }
    ...
    sendMediaMessage(message: RCIMIWMediaMessage): Promise<number> {
        return this._invokeMethod<number>('sendMediaMessage', { message });
    }
    ...
    cancelSendingMediaMessage(message: RCIMIWMediaMessage): Promise<number> {
        return this._invokeMethod<number>('cancelSendingMediaMessage', { message });
    }
    ...
    downloadMediaMessage(message: RCIMIWMediaMessage): Promise<number> {
        return this._invokeMethod<number>('downloadMediaMessage', { message });
    }
    ...
    cancelDownloadingMediaMessage(message: RCIMIWMediaMessage): Promise<number> {
        return this._invokeMethod<number>('cancelDownloadingMediaMessage', { message });
    }
    ...
    loadConversation(type: RCIMIWConversationType, targetId: string, channelId: string): Promise<number> {
        return this._invokeMethod<number>('loadConversation', { type, targetId, channelId });
    }
    ...
    loadConversations(
        ...
        return this._invokeMethod<number>('loadConversations', { conversationTypes, channelId, startTime, count });
    }
    ...
    removeConversation(type: RCIMIWConversationType, targetId: string, channelId: string): Promise<number> {
        return this._invokeMethod<number>('removeConversation', { type, targetId, channelId });
    }
    ...
    removeConversations(conversationTypes: Array<RCIMIWConversationType>, channelId: string): Promise<number> {
        return this._invokeMethod<number>('removeConversations', { conversationTypes, channelId });
    }
    ...
    loadUnreadCount(type: RCIMIWConversationType, targetId: string, channelId: string): Promise<number> {
        return this._invokeMethod<number>('loadUnreadCount', { type, targetId, channelId });
    }
    ...
    loadTotalUnreadCount(channelId: string): Promise<number> {
        return this._invokeMethod<number>('loadTotalUnreadCount', { channelId });
    }
    ...
    loadUnreadMentionedCount(type: RCIMIWConversationType, targetId: string, channelId: string): Promise<number> {
        return this._invokeMethod<number>('loadUnreadMentionedCount', { type, targetId, channelId });
    }
    ...
    loadUltraGroupAllUnreadCount(): Promise<number> {
        return this._invokeMethod<number>('loadUltraGroupAllUnreadCount', {});
    }
    ...
    loadUltraGroupAllUnreadMentionedCount(): Promise<number> {
        return this._invokeMethod<number>('loadUltraGroupAllUnreadMentionedCount', {});
    }
    ...
    loadUltraGroupUnreadCount(targetId: string): Promise<number> {
        return this._invokeMethod<number>('loadUltraGroupUnreadCount', { targetId });
    }
    ...
    loadUltraGroupUnreadMentionedCount(targetId: string): Promise<number> {
        return this._invokeMethod<number>('loadUltraGroupUnreadMentionedCount', { targetId });
    }
    ...
    loadUnreadCountByConversationTypes(
        ...
        return this._invokeMethod<number>('loadUnreadCountByConversationTypes', {
            conversationTypes,
            channelId,
            contain,
        });
    ...
    clearUnreadCount(
        ...
        return this._invokeMethod<number>('clearUnreadCount', { type, targetId, channelId, timestamp });
    }
    ...
    saveDraftMessage(
        ...
        return this._invokeMethod<number>('saveDraftMessage', { type, targetId, channelId, draft });
    }
    ...
    loadDraftMessage(type: RCIMIWConversationType, targetId: string, channelId: string): Promise<number> {
        return this._invokeMethod<number>('loadDraftMessage', { type, targetId, channelId });
    }
    ...
    clearDraftMessage(type: RCIMIWConversationType, targetId: string, channelId: string): Promise<number> {
        return this._invokeMethod<number>('clearDraftMessage', { type, targetId, channelId });
    }
    ...
    loadBlockedConversations(conversationTypes: Array<RCIMIWConversationType>, channelId: string): Promise<number> {
        return this._invokeMethod<number>('loadBlockedConversations', { conversationTypes, channelId });
    }
    ...
    changeConversationTopStatus(
        ...
        return this._invokeMethod<number>('changeConversationTopStatus', { type, targetId, channelId, top });
    }
    ...
    loadConversationTopStatus(type: RCIMIWConversationType, targetId: string, channelId: string): Promise<number> {
        return this._invokeMethod<number>('loadConversationTopStatus', { type, targetId, channelId });
    }
    ...
    syncConversationReadStatus(
        ...
        return this._invokeMethod<number>('syncConversationReadStatus', { type, targetId, channelId, timestamp });
    }
    ...
    sendTypingStatus(
        ...
        return this._invokeMethod<number>('sendTypingStatus', { type, targetId, channelId, currentType });
    }
    ...
    loadMessages(
        ...
        return this._invokeMethod<number>('loadMessages', {
            type,
            targetId,
            channelId,
            sentTime,
    ...
    loadFirstUnreadMessage(type: RCIMIWConversationType, targetId: string, channelId: string): Promise<number> {
        return this._invokeMethod<number>('loadFirstUnreadMessage', { type, targetId, channelId });
    }
    ...
    loadUnreadMentionedMessages(type: RCIMIWConversationType, targetId: string, channelId: string): Promise<number> {
        return this._invokeMethod<number>('loadUnreadMentionedMessages', { type, targetId, channelId });
    }
    ...
    insertMessage(message: RCIMIWMessage): Promise<number> {
        return this._invokeMethod<number>('insertMessage', { message });
    }
    ...
    insertMessages(messages: Array<RCIMIWMessage>): Promise<number> {
        return this._invokeMethod<number>('insertMessages', { messages });
    }
    ...
    clearMessages(
        ...
        return this._invokeMethod<number>('clearMessages', { type, targetId, channelId, timestamp, policy });
    }
    ...
    deleteLocalMessages(messages: Array<RCIMIWMessage>): Promise<number> {
        return this._invokeMethod<number>('deleteLocalMessages', { messages });
    }
    ...
    deleteMessages(
        ...
        return this._invokeMethod<number>('deleteMessages', { type, targetId, channelId, messages });
    }
    ...
    recallMessage(message: RCIMIWMessage): Promise<number> {
        return this._invokeMethod<number>('recallMessage', { message });
    }
    ...
    sendPrivateReadReceiptMessage(targetId: string, channelId: string, timestamp: number): Promise<number> {
        return this._invokeMethod<number>('sendPrivateReadReceiptMessage', { targetId, channelId, timestamp });
    }
    ...
    sendGroupReadReceiptRequest(message: RCIMIWMessage): Promise<number> {
        return this._invokeMethod<number>('sendGroupReadReceiptRequest', { message });
    }
    ...
    sendGroupReadReceiptResponse(targetId: string, channelId: string, messages: Array<RCIMIWMessage>): Promise<number> {
        return this._invokeMethod<number>('sendGroupReadReceiptResponse', { targetId, channelId, messages });
    }
     ...
     */
    updateMessageExpansion(messageUId: string, expansion: { [propName: string]: string }): Promise<number> {
        return this._invokeMethod<number>('updateMessageExpansion', { messageUId, expansion });
    }
    ...
    removeMessageExpansionForKeys(messageUId: string, keys: Array<string>): Promise<number> {
        return this._invokeMethod<number>('removeMessageExpansionForKeys', { messageUId, keys });
    }
    ...
    changeMessageSentStatus(messageId: number, sentStatus: RCIMIWSentStatus): Promise<number> {
        return this._invokeMethod<number>('changeMessageSentStatus', { messageId, sentStatus });
    }
    ...
    changeMessageReceiveStatus(messageId: number, receivedStatus: RCIMIWReceivedStatus): Promise<number> {
        return this._invokeMethod<number>('changeMessageReceiveStatus', { messageId, receivedStatus });
    }
    ...
    joinChatRoom(targetId: string, messageCount: number, autoCreate: boolean): Promise<number> {
        return this._invokeMethod<number>('joinChatRoom', { targetId, messageCount, autoCreate });
    }
    ...
    leaveChatRoom(targetId: string): Promise<number> {
        return this._invokeMethod<number>('leaveChatRoom', { targetId });
    }
    ...
    loadChatRoomMessages(targetId: string, timestamp: number, order: RCIMIWTimeOrder, count: number): Promise<number> {
        return this._invokeMethod<number>('loadChatRoomMessages', { targetId, timestamp, order, count });
    }
    ...
    addChatRoomEntry(
        ...
        return this._invokeMethod<number>('addChatRoomEntry', { targetId, key, value, deleteWhenLeft, overwrite });
    }
    ...
    addChatRoomEntries(
        targetId: string,
        entries: { [propName: string]: string },
        deleteWhenLeft: boolean,
        overwrite: boolean
    ): Promise<number> {
        return this._invokeMethod<number>('addChatRoomEntries', { targetId, entries, deleteWhenLeft, overwrite });
    }
    ...
    loadChatRoomEntry(targetId: string, key: string): Promise<number> {
        return this._invokeMethod<number>('loadChatRoomEntry', { targetId, key });
    }
    ...
    loadAllChatRoomEntries(targetId: string): Promise<number> {
        return this._invokeMethod<number>('loadAllChatRoomEntries', { targetId });
    }
    ...
    removeChatRoomEntry(targetId: string, key: string, force: boolean): Promise<number> {
        return this._invokeMethod<number>('removeChatRoomEntry', { targetId, key, force });
    }
    ...
    removeChatRoomEntries(targetId: string, keys: Array<string>, force: boolean): Promise<number> {
        return this._invokeMethod<number>('removeChatRoomEntries', { targetId, keys, force });
    }
    ...
    addToBlacklist(userId: string): Promise<number> {
        return this._invokeMethod<number>('addToBlacklist', { userId });
    }
    ...
    removeFromBlacklist(userId: string): Promise<number> {
        return this._invokeMethod<number>('removeFromBlacklist', { userId });
    }
    ...
    loadBlacklistStatus(userId: string): Promise<number> {
        return this._invokeMethod<number>('loadBlacklistStatus', { userId });
    }
    ...
    loadBlacklist(): Promise<number> {
        return this._invokeMethod<number>('loadBlacklist', {});
    }
    ...
    searchMessages(
        ...
        return this._invokeMethod<number>('searchMessages', { type, targetId, channelId, keyword, startTime, count });
    }
    ...
    searchMessagesByTimeRange(
        ...
        return this._invokeMethod<number>('searchMessagesByTimeRange', {
            type,
            targetId,
            channelId,
            keyword,
    ...
    searchMessagesByUserId(
        ...
        return this._invokeMethod<number>('searchMessagesByUserId', {
            userId,
            type,
            targetId,
            channelId,
    ...
    searchConversations(
        ...
        return this._invokeMethod<number>('searchConversations', {
            conversationTypes,
            channelId,
            messageTypes,
            keyword,
    ...
    changeNotificationQuietHours(
        ...
        return this._invokeMethod<number>('changeNotificationQuietHours', { startTime, spanMins, level });
    }
    ...
    removeNotificationQuietHours(): Promise<number> {
        return this._invokeMethod<number>('removeNotificationQuietHours', {});
    }
    ...
    loadNotificationQuietHours(): Promise<number> {
        return this._invokeMethod<number>('loadNotificationQuietHours', {});
    }
    ...
    changeConversationNotificationLevel(
        ...
        return this._invokeMethod<number>('changeConversationNotificationLevel', { type, targetId, channelId, level });
    }
    ...
    loadConversationNotificationLevel(
        ...
        return this._invokeMethod<number>('loadConversationNotificationLevel', { type, targetId, channelId });
    }
    ...
    changeConversationTypeNotificationLevel(
        ...
        return this._invokeMethod<number>('changeConversationTypeNotificationLevel', { type, level });
    }
    ...
    loadConversationTypeNotificationLevel(type: RCIMIWConversationType): Promise<number> {
        return this._invokeMethod<number>('loadConversationTypeNotificationLevel', { type });
    }
    ...
    changeUltraGroupDefaultNotificationLevel(targetId: string, level: RCIMIWPushNotificationLevel): Promise<number> {
        return this._invokeMethod<number>('changeUltraGroupDefaultNotificationLevel', { targetId, level });
    }
    ...
    loadUltraGroupDefaultNotificationLevel(targetId: string): Promise<number> {
        return this._invokeMethod<number>('loadUltraGroupDefaultNotificationLevel', { targetId });
    }
    ...
    changeUltraGroupChannelDefaultNotificationLevel(
        ...
        return this._invokeMethod<number>('changeUltraGroupChannelDefaultNotificationLevel', {
            targetId,
            channelId,
            level,
        });
    ...
    loadUltraGroupChannelDefaultNotificationLevel(targetId: string, channelId: string): Promise<number> {
        return this._invokeMethod<number>('loadUltraGroupChannelDefaultNotificationLevel', { targetId, channelId });
    }
    ...
    changePushContentShowStatus(showContent: boolean): Promise<number> {
        return this._invokeMethod<number>('changePushContentShowStatus', { showContent });
    }
    ...
    changePushLanguage(language: string): Promise<number> {
        return this._invokeMethod<number>('changePushLanguage', { language });
    }
    ...
    changePushReceiveStatus(receive: boolean): Promise<number> {
        return this._invokeMethod<number>('changePushReceiveStatus', { receive });
    }
    ...
    sendGroupMessageToDesignatedUsers(message: RCIMIWMessage, userIds: Array<string>): Promise<number> {
        return this._invokeMethod<number>('sendGroupMessageToDesignatedUsers', { message, userIds });
    }
    ...
    loadMessageCount(type: RCIMIWConversationType, targetId: string, channelId: string): Promise<number> {
        return this._invokeMethod<number>('loadMessageCount', { type, targetId, channelId });
    }
    ...
    loadTopConversations(conversationTypes: Array<RCIMIWConversationType>, channelId: string): Promise<number> {
        return this._invokeMethod<number>('loadTopConversations', { conversationTypes, channelId });
    }
    ...
    syncUltraGroupReadStatus(targetId: string, channelId: string, timestamp: number): Promise<number> {
        return this._invokeMethod<number>('syncUltraGroupReadStatus', { targetId, channelId, timestamp });
    }
    ...
    loadConversationsForAllChannel(type: RCIMIWConversationType, targetId: string): Promise<number> {
        return this._invokeMethod<number>('loadConversationsForAllChannel', { type, targetId });
    }
    ...
    modifyUltraGroupMessage(messageUId: string, message: RCIMIWMessage): Promise<number> {
        return this._invokeMethod<number>('modifyUltraGroupMessage', { messageUId, message });
    }
    ...
    recallUltraGroupMessage(message: RCIMIWMessage, deleteRemote: boolean): Promise<number> {
        return this._invokeMethod<number>('recallUltraGroupMessage', { message, deleteRemote });
    }
    ...
    clearUltraGroupMessages(
        ...
        return this._invokeMethod<number>('clearUltraGroupMessages', { targetId, channelId, timestamp, policy });
    }
    ...
    sendUltraGroupTypingStatus(
        ...
        return this._invokeMethod<number>('sendUltraGroupTypingStatus', { targetId, channelId, typingStatus });
    }
    ...
    clearUltraGroupMessagesForAllChannel(targetId: string, timestamp: number): Promise<number> {
        return this._invokeMethod<number>('clearUltraGroupMessagesForAllChannel', { targetId, timestamp });
    }
    ...
    loadBatchRemoteUltraGroupMessages(messages: Array<RCIMIWMessage>): Promise<number> {
        return this._invokeMethod<number>('loadBatchRemoteUltraGroupMessages', { messages });
    }
     ...
     */
    updateUltraGroupMessageExpansion(messageUId: string, expansion: { [propName: string]: string }): Promise<number> {
        return this._invokeMethod<number>('updateUltraGroupMessageExpansion', { messageUId, expansion });
    }
    ...
    removeUltraGroupMessageExpansion(messageUId: string, keys: Array<string>): Promise<number> {
        return this._invokeMethod<number>('removeUltraGroupMessageExpansion', { messageUId, keys });
    }
    ...
    changeLogLevel(level: RCIMIWLogLevel): Promise<number> {
        return this._invokeMethod<number>('changeLogLevel', { level });
    }
    ...
    setOnRemoteMessageExpansionForKeyRemovedListener(
        listener?: (res: OnRemoteMessageExpansionForKeyRemovedResult) => void
    ): void {
    ...
    setOnConversationReadStatusSyncMessageReceivedListener(
        listener?: (res: OnConversationReadStatusSyncMessageReceivedResult) => void
    ): void {
    ...
    setOnRemoteUltraGroupMessageExpansionUpdatedListener(
        listener?: (res: OnRemoteUltraGroupMessageExpansionUpdatedResult) => void
    ): void {
    ...
    setOnRemoteUltraGroupMessageModifiedListener(
        listener?: (res: OnRemoteUltraGroupMessageModifiedResult) => void
    ): void {
    ...
    setOnRemoteUltraGroupMessageRecalledListener(
        listener?: (res: OnRemoteUltraGroupMessageRecalledResult) => void
    ): void {
 ...
 */
    ...
    setOnGroupMessageReadReceiptRequestReceivedListener(
        listener?: (res: OnGroupMessageReadReceiptRequestReceivedResult) => void
    ): void {
    ...
    setOnGroupMessageReadReceiptResponseReceivedListener(
        listener?: (res: OnGroupMessageReadReceiptResponseReceivedResult) => void
    ): void {
    ...
    setOnUnreadCountByConversationTypesLoadedListener(
        listener?: (res: OnUnreadCountByConversationTypesLoadedResult) => void
    ): void {
    ...
    setOnUltraGroupAllUnreadCountLoadedListener(
        listener?: (res: OnUltraGroupAllUnreadCountLoadedResult) => void
    ): void {
    ...
    setOnUltraGroupAllUnreadMentionedCountLoadedListener(
        listener?: (res: OnUltraGroupAllUnreadMentionedCountLoadedResult) => void
    ): void {
    ...
    setOnDownloadingMediaMessageCanceledListener(
        listener?: (res: OnDownloadingMediaMessageCanceledResult) => void
    ): void {
    ...
    setOnMessageExpansionForKeysRemovedListener(
        listener?: (res: OnMessageExpansionForKeysRemovedResult) => void
    ): void {
    ...
    setOnConversationNotificationLevelChangedListener(
        listener?: (res: OnConversationNotificationLevelChangedResult) => void
    ): void {
    ...
    setOnConversationNotificationLevelLoadedListener(
        listener?: (res: OnConversationNotificationLevelLoadedResult) => void
    ): void {
    ...
    setOnConversationTypeNotificationLevelChangedListener(
        listener?: (res: OnConversationTypeNotificationLevelChangedResult) => void
    ): void {
    ...
    setOnConversationTypeNotificationLevelLoadedListener(
        listener?: (res: OnConversationTypeNotificationLevelLoadedResult) => void
    ): void {
    ...
    setOnUltraGroupDefaultNotificationLevelChangedListener(
        listener?: (res: OnUltraGroupDefaultNotificationLevelChangedResult) => void
    ): void {
    ...
    setOnUltraGroupDefaultNotificationLevelLoadedListener(
        listener?: (res: OnUltraGroupDefaultNotificationLevelLoadedResult) => void
    ): void {
    ...
    setOnUltraGroupChannelDefaultNotificationLevelChangedListener(
        listener?: (res: OnUltraGroupChannelDefaultNotificationLevelChangedResult) => void
    ): void {
    ...
    setOnUltraGroupChannelDefaultNotificationLevelLoadedListener(
        listener?: (res: OnUltraGroupChannelDefaultNotificationLevelLoadedResult) => void
    ): void {
 ...
 */
    setOnGroupMessageToDesignatedUsersAttachedListener(
        listener?: (res: OnGroupMessageToDesignatedUsersAttachedResult) => void
    ): void {
 ...
 */
    setOnGroupMessageToDesignatedUsersSentListener(
        listener?: (res: OnGroupMessageToDesignatedUsersSentResult) => void
    ): void {
    ...
    setOnConversationsLoadedForAllChannelListener(
        listener?: (res: OnConversationsLoadedForAllChannelResult) => void
    ): void {
    ...
    setOnUltraGroupUnreadMentionedCountLoadedListener(
        listener?: (res: OnUltraGroupUnreadMentionedCountLoadedResult) => void
    ): void {
    ...
    setOnUltraGroupMessagesClearedForAllChannelListener(
        listener?: (res: OnUltraGroupMessagesClearedForAllChannelResult) => void
    ): void {
    ...
    setOnBatchRemoteUltraGroupMessagesLoadedListener(
        listener?: (res: OnBatchRemoteUltraGroupMessagesLoadedResult) => void
    ): void {
    ...
    setOnUltraGroupMessageExpansionUpdatedListener(
        listener?: (res: OnUltraGroupMessageExpansionUpdatedResult) => void
    ): void {
    ...
    setOnUltraGroupMessageExpansionRemovedListener(
        listener?: (res: OnUltraGroupMessageExpansionRemovedResult) => void
    ): void {
